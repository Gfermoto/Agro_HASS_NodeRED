...
### Как изменить время полива?
Время полива настраивается в потоке Node-RED. Найдите ноду "Расписание" и измените значение `watering_time`.

### Что делать, если датчик влажности показывает неверные данные?
1. Проверьте заряд батареи датчика
2. Убедитесь, что датчик находится на правильной глубине
3. Проверьте подключение к шлюзу GW2000A